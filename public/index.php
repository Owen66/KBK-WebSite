...
$app->get('/products', 'kbk\ProductsController::productsAction');
$app->get('/products/{cat}', 'kbk\ProductsController::catAction');
$app->get('/item/{itemId}', 'kbk\ProductsController::itemAction');
